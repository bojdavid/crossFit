...
function Footer() {
 const fieldTextStyle = "text-lg sm:text-xl lg:text-[22px] font-bold uppercase tracking-wide mb-4 lg:mb-[16.98px]";
 const desc_TextStyle = "font-light text-[#FFFFFF] leading-6 sm:leading-7 lg:leading-[28px] tracking-wide lg:tracking-[0.8px]";
      ...
      <div className='w-full max-w-[1330px] mx-auto'>
        <section className="min-h-[200px] sm:min-h-[220px] lg:h-[260px] flex items-center py-8 lg:py-0">
            ...
            <div className="flex-1">
                ...
                <span className="underline break-all sm:break-normal">kropp@qodeinteractive.com</span> for
        ...
        <section className="py-8 lg:py-12 w-full">
            ...
            <div className="col-span-1">
                ...
                <div className={`${desc_TextStyle} space-y-3 lg:space-y-[13px]`}>
                <div>
            ...
            <div className="col-span-1">
                ...
                <p className="break-all sm:break-normal">kropp@qodeinteractive.com</p>
                <p>+ (1) 718 - 407 - 6400</p>
                </div>
            </div>
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
                ...
                Start Now <img src={arrow_down} alt="" className='w-4 h-4 lg:w-[16.3px] lg:h-[16.3px]' />
                </h3>
                ...
                <div className='border border-white/40 border-r-0 rounded-full flex w-full'>
                    ...
                    >
                        <img src={arrow} alt="" className='w-6 h-6 lg:w-auto lg:h-auto' />
                    </button>
                </div>
                </form>
