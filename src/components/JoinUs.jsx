...
function JoinUs() {
  ...
  const scales = "scale-70 sm:scale-75 md:scale-90  lg:scale-100"
  ...
  return (
        <div className="w-full text-[#ffffff] ">
            ...
            <h1 className='uppercase font-bold text-4xl sm:text-6xl md:text-8xl lg:text-[100px]  xl:text-[130px] 3xl:text-[160px] 5xl:text-[180px] text-center md:mt-[-75px] relative z-50 leading-none flex justify-center gap-3  '>
                Join Us 
        ...
        <div className='mx-auto  flex items-center flex-col  mt-[22px] sm:mt-[42px] md:mt-[62px]  lg:mt-[82px] font-heebo'>
            {headerText("COI", "Start Here", "Fill the form below to start your journey", "Subscribe")}
            <form action=" " className='mt-[52px] flex justify-center items-center gap-5 flex-wrap sm:flex-nowrap px-1 w-full px-3'>
