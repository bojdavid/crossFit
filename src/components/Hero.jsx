    ...
    <div className="mx-auto text-[#FFFFFF] ">
      ...
      <div className="min-h-[70vh] sm:min-h-[80vh] lg:h-[985px] flex items-center lg:items-end py-8 lg:py-0">
        <div className="mx-auto text-center lg:text-left w-full flex justifu-center">
          <div className="mx-auto animate-on-scroll">
      ...
      <div className="mx-auto max-w-[1920px]">
        ...
        <div className="bg-[#000000] w-full">
          <div className="w-full max-w-[1300px] min-h-[500px] lg:h-[637.16px] flex flex-col lg:flex-row items-center justify-between mx-auto gap-8 lg:gap-0 py-8 lg:py-0">
            <div className="w-full lg:w-[481.42px] my-auto relative order-2 lg:order-1 px-4 lg:px-0 animate-on-scroll">
              {infoText(
                "Stronger",
            ...
            <div className="w-full lg:w-[518px] flex justify-center lg:justify-end order-1 lg:order-2 animate-on-scroll">
              <img
                src={hero1}
        ...
        <div className="w-full ">
          <div className="w-full max-w-[1300px]  min-h-[500px] lg:h-[637.16px] flex flex-col lg:flex-row items-center justify-between mx-auto gap-8 lg:gap-0 py-8 lg:py-0">
            <div className="w-full lg:w-[518px] flex justify-center lg:justify-start order-1 animate-on-scroll">
              <img
                src={hero2}
                alt="Picture of someone doing pull ups"
                className="w-full max-w-[400px] sm:max-w-[450px] lg:max-w-[518px] h-auto lg:h-[760.16px] object-cover rounded-lg lg:rounded-none"
            ...
            <div className="w-full lg:w-[481.42px] my-auto order-2 px-4 lg:px-0 animate-on-scroll">
              {infoText(
                "Start",
                "Today is the best day to start!",
                "Unumhis solum justo ex ius. Pro cu probo laboramus eius insolens euripidis te eos, ut agam tota.",
                "View More"
              )}
            </div>
          </div>
